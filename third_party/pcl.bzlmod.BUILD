...
cc_test(
    ...
    args = ["$(location test/colored_cloud.pcd)"],
...
cc_test(
    ...
    args = [
        "$(location test/bun0.pcd)",
        "$(location test/milk.pcd)",
    ],
    data = [
        "test/bun0.pcd",
        "test/milk.pcd",
...
cc_test(
    ...
    args = ["$(location test/table_scene_mug_stereo_textured.pcd)"],
...
cc_test(
    ...
    args = ["$(location test/lamppost.pcd)"],
...
cc_test(
    ...
    args = [
        "$(location test/rops_cloud.pcd)",
        "$(location test/rops_indices.txt)",
        "$(location test/rops_triangles.txt)",
    ],
    data = [
        "test/rops_cloud.pcd",
...
cc_test(
    ...
    args = [
        "$(location test/brisk_descriptors_gt.pcd)",
        "$(location test/brisk_image_gt.pcd)",
        "$(location test/brisk_keypoints_gt.pcd)",
    ],
    data = [
...
cc_test(
    ...
    args = ["$(location test/milk_cartoon_all_small_clorox.pcd)"],
...
cc_test(
    ...
    args = [
        "$(location test/bun0.pcd)",
        "$(location test/milk_cartoon_all_small_clorox.pcd)",
    ],
    data = [
        "test/bun0.pcd",
...
cc_test(
    ...
    args = ["$(location test/grabber_sequences)"],
...
cc_test(
    ...
    args = ["$(location test/milk_color.pcd)"],
...
cc_test(
    ...
    args = [
        "$(location test/bun0.pcd)",
        "$(location test/bun4.pcd)",
        "$(location test/milk_color.pcd)",
    ],
    data = [
        "test/bun0.pcd",
        "test/bun4.pcd",
...
cc_test(
    ...
    args = [
        "$(location test/office1_keypoints.pcd)",
        "$(location test/office2_keypoints.pcd)",
    ],
    data = [
...
cc_test(
    ...
    args = ["$(location test/sac_plane_test.pcd)"],
...
cc_test(
    ...
    args = ["$(location test/office1.pcd)"],
